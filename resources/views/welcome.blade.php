    ...
    <div class="container">
      ...
      <section class="content">
        ...
        <header class="jumbotron hero-spacer">
            ...
            <p>{{ trans('welcome.description') }}</p>
            @if (Auth::guest())
            <p><a href="/signup" class="btn bg-purple">{{ trans('welcome.create_account') }}</a></p>
            @else
            <p><a href="/account" class="btn bg-purple">{{ trans('welcome.my_profile') }}</a></p>
            @endif
        </header>
